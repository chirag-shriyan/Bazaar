    ...
    return (
        ...
        <>
            ...
            <div className={`ml-4 mt-10 space-y-3 w-full flex flex-col bg-black`}>
                ...
                <Link
                    to={'/admin/settings'} className='w-fit space-x-2 text-lg flex items-center cursor-pointer'
                    onClick={(e) => setShowMenu(false)}
                    style={{ color: active === 'settings' && '#0a77fa' }}
                    id='Settings'
                >
                    <AiOutlineSetting style={{ color: active === 'settings' && '#0a77fa' }} />
                    <h1>Settings</h1>
                </Link>
            </div>
